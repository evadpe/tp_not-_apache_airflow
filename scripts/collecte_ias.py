...
"""
from __future__ import annotations #j'ai rajouté ça car j'avais des problème de synatxe des types hints sur python 3.8
...
def filtrer_semaine(rows: list[dict], semaine: str) -> list[dict]:
    ...
    # Correction : On extrait le numéro après le 'S' (ex: 2024-S05 -> 05)
